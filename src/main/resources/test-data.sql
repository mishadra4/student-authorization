...
INSERT INTO USER (USERNAME, PASSWORD, ENABLED) VALUES ('teacher@gmail.com','12345',TRUE);
...
INSERT INTO USER (USERNAME, PASSWORD, ENABLED) VALUES ('student@outlook.com','12345',TRUE);
INSERT INTO USER (USERNAME, PASSWORD, ENABLED) VALUES ('superuser@outlook.com','12345',TRUE);


-- INSERT INTO STUDENT (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ID_LECTURE, ID_GROUP) VALUES ('test3', 'test3', 'roleuser@outlook.com', '12345', '0001', 'KH-310');
-- INSERT INTO STUDENT (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ID_LECTURE, ID_GROUP) VALUES ('test3', 'test3', 'student@outlook.com','12345', '0001', 'KH-310');
-- INSERT INTO STUDENT (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ID_LECTURE, ID_GROUP) VALUES ('test4', 'test4', 'admin@gmail.com','12345', '0001', 'KH-310');
-- INSERT INTO STUDENT (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ID_LECTURE, ID_GROUP) VALUES ('test4', 'test4', 'teacher@gmail.com','12345', '0001', 'KH-310');
--INSERT INTO USER (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ENABLED) VALUES ('test3', 'test3', 'test5@outlook.com','12345',TRUE);
--INSERT INTO USER (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, ENABLED) VALUES ('test3', 'test3', 'test6@outlook.com','12345',TRUE);

--LECTURES
-- INSERT INTO LECTURE (ID_LECTURE) VALUES('0001');
-- INSERT INTO LECTURE (ID_LECTURE) VALUES('0002');

--AUTHORITIES
INSERT INTO AUTHORITIES (USERNAME,AUTHORITY) VALUES ('admin@gmail.com','ROLE_ADMIN');
INSERT INTO AUTHORITIES (USERNAME,AUTHORITY) VALUES ('teacher@gmail.com','ROLE_ADMIN');
INSERT INTO AUTHORITIES (USERNAME,AUTHORITY) VALUES ('roleuser@outlook.com','ROLE_USER');
INSERT INTO AUTHORITIES (USERNAME,AUTHORITY) VALUES ('student@outlook.com','ROLE_USER');
